                        ...
                        @endif
                            ...
                            <div class="jarviswidget jarviswidget-color-darken" id="wid-id-0" data-widget-editbutton="false">
                                ...
                                <header>
                                    ...
                                    <div style="margin:6px">Varyant Grupları</div>
                                    ...
                                    <div class="widget-body no-padding">
                                        ...
                                        <table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
                                            ...
                                            <tr>
                                                ...
                                                <th data-class="expand"><i class="text-muted hidden-md hidden-sm hidden-xs"></i> Varyant Değerleri</th>
                                                <th>Durum</th>
                                            ...
                                            @foreach($optionGroups as $opt)
                                                ...
                                                <tr>
                                                    <td>{{ $i }}</td>
                                                    <td>{{ $opt->option_group_order }}</td>
                                                    <td>{{ $opt->option_group_name }}</td>
                                                    <td>
                                                        <div class="smart-form">
                                                            <label class="toggle">
                                                                <input type="checkbox" name="" onchange="statusChange(this, '{{ $opt->id }}', 'optionGroups')" {{ $opt->option_group_status=='1' ? 'checked="checked"' : '' }}>
                                                                <i style="left:0" data-swchon-text="Aktif" data-swchoff-text="Pasif"></i>
                                                            </label>
                                                        </div>
                                                    </td>
                                                    <td><a href="{{ route('admin-secenek-degerleri', $opt->id) }}">Varyant Değerleri</a></td>
                                                    <td>
                                                        <a href="javascript:void(0)" onclick="editOptionGroup('{{ $opt->id }}')"  rel="tooltip" data-placement="top" data-original-title="Düzenle" class="btn btn-labeled btn-primary"> <i class="glyphicon glyphicon-edit"></i> </a>
                                                        <a href="javascript:void(0)"
                                                           onclick="warning('{{ route("admin-secenek-grup-sil", [$opt->id, "_token" => csrf_token()]) }}', 'Varyant Grubunu silmek istediğinize emin misiniz? Varsa Varyant Değerleri de silinecektir.')"
                                                           rel="tooltip" data-placement="top" data-original-title="Varyant Grubunu Sil"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">Yeni Varyant Grubu Ekle</h4>
                </div>
                <div class="modal-body">
                    <form method="post" action="{{ route('admin-secenek-grup-ekle-p') }}" id="form" class="form-horizontal">
                        <div class="row">
                            <div class="col-md-12">
...
@section('footer_jscript')
    <script type="text/javascript">
        ...
        function editOptionGroup(ID) {
            ...
            $.post('{{ route("admin-secenek-grup-duzenle") }}', {ID:ID}, function(resp) {
                if(!resp.length){
                    alert();
                    return false;
                }
