                                    ...
                                    <form id="togglingForm" method="post" class="form-horizontal">
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-5">
                                                    <input type="text" class="form-control" name="sayfa_adi" value="{{ $content->content_name }}" />
                                                </div>
                                            </div>
                                        </fieldset>
                                                ...
                                                <div class="col-lg-5">
                                                    <select name="sayfa_turu" class="form-control">
                                                        ...
                                                        @foreach($contentCats as $cat)
                                                            <option {{ $cat->id==$content->content_category_id ? 'selected' : '' }} value="{{ $cat->id }}">{{ $cat->content_category_name }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-5">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" name="sayfa_url" value="{{ $content->content_page_url }}" />
                                                    </div>
                                                </div>
                                            </div>
                                        </fieldset>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-5">
                                                    <div class="smart-form">
                                                        <label class="toggle">
                                                            <input type="checkbox" name="sayfa_durum"  {{ $content->content_status=='1' ? 'checked="checked"' : '' }}>
                                        ...
                                        <fieldset>
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-5">
                                                    <textarea name="kisa_aciklama" id="" class="form-control" rows="5">{{$content->content_short_detail}}</textarea>
                                                </div>
                                            </div>
                                        </fieldset>
                                        ...
                                        <fieldset>
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-5">
                                                    <textarea name="sayfa_detay" id="" class="form-control" rows="5">{{$content->content_detail}}</textarea>
                                                </div>
                                            </div>
                                        </fieldset>
                                        ...
                                        <fieldset>
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-5">
                                                    <input name="keywords" class="form-control tagsinput" value="{{$content->content_keywords}}" data-role="tagsinput" style="display: none;">
                                                </div>
                                            </div>
                                        </fieldset>
                                        ...
                                        <fieldset>
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-5">
                                                    <textarea name="description" id="" class="form-control" rows="5">{{$content->content_description}}</textarea>
                                                </div>
                                            </div>
                                        </fieldset>
