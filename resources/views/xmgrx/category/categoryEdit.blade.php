                                    ...
                                    <form id="togglingForm" method="post" class="form-horizontal" enctype="multipart/form-data">
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-5">
                                                    <input type="text" class="form-control" name="kategori_adi" value="{{ $currentCategory->category_name }}" />
                                                </div>
                                            </div>
                                        </fieldset>
                                        ...
                                        <fieldset>
                                            <div class="form-group">
                                                ...
                                                @if(!empty($currentCategory->category_image) && file_exists($categoryImageDestination.$currentCategory->category_image))
                                                <div class="col-lg-1">
                                                    <a href="javascript:void(0);" rel="tooltip" data-placement="top" data-original-title="<img width='150' src='{{ $categoryImageUrl.$currentCategory->category_image }}' class='online' />" data-html="true" class="btn btn-primary"><i class="glyphicon glyphicon-camera"></i></a>
                                                </div>
                                                @endif
                                            </div>
                                        </fieldset>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-5">
                                                    <div class="smart-form">
                                                        <label class="toggle">
                                                            <input type="checkbox" name="kategori_durum" {{ $currentCategory->category_status=='1' ? 'checked="checked"' : '' }}>
                                        ...
                                        <fieldset>
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-5">
                                                    <input name="keywords" class="form-control tagsinput"  value="{{ $currentCategory->meta_keywords }}" data-role="tagsinput" style="display: none;">
                                                </div>
                                            </div>
                                        </fieldset>
                                        ...
                                        <fieldset>
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-5">
                                                    <textarea name="description" id="" class="form-control" rows="5">{{ $currentCategory->meta_description }}</textarea>
                                                </div>
                                            </div>
                                        </fieldset>
