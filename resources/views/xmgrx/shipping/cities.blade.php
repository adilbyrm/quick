                    ...
                    <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            ...
                            <div class="jarviswidget jarviswidget-color-darken" id="wid-id-0" data-widget-editbutton="false">
                                ...
                                <header>
                                    ...
                                    <div style="margin:6px">Şehirler</div>
                                    ...
                                    <div class="widget-body no-padding">
                                        ...
                                        <table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
                                            ...
                                            <tr>
                                                ...
                                                <th data-class="expand"><i class="text-muted hidden-md hidden-sm hidden-xs"></i> Şehir</th>
                                                <th>Durum</th>
                                            </tr>
                                            </thead>
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="smart-form">
                                                            <label class="toggle">
                                                                <input type="checkbox" name="" onchange="statusChange(this, '{{ $city->id }}', 'city')" {{ $city->city_status=='1' ? 'checked="checked"' : '' }}>
